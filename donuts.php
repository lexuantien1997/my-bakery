...
<div class="row slider">
	...
	<div class="row">
      <div class="col-md-2 col-md-offset-1">
		...
		<div class="bg-lienhe-sanpham2 h2-sanpham2" style="padding-left:30px; color:#000">Donuts</div>
       ...
       <?php 
		...
		if(isset($_GET['sp']))
		{
			...
			echo'<meta http-equiv="refresh" content="0; donuts.php" />';
		}
		$dem=0;
		$page=1;
		if(isset($_GET['page']))
		...
		$vitri=($page-1)*8;
		$kq=truyvan("select * from sanpham where maloai='L01' limit $vitri,8");
		foreach($kq as $r)
		{
          ...
          //  $english_format_number = number_format($r["gia"]);
            ...
            //     <a onClick='thongbao()' href='donuts.php?sp={$r['masp']}'>
...
<?php
		...
		$sosp=count(truyvan("select * from sanpham where maloai in('L01')"));
		$sotrang=ceil($sosp/8);
		phantrang('donuts.php',$page,$sotrang);
		?>
        </div>

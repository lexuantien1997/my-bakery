...
<div class="row slider">
	...
	<div class="row">
      <div class="col-md-2 col-md-offset-1">
		...
		<div class="bg-lienhe-sanpham2 h2-sanpham2" style="padding-left:30px; color:#000">Đồ ăn</div>
		...
		if(isset($_GET['sp']))
		{
			...
			echo'<meta http-equiv="refresh" content="0; do-an.php" />';
		}
		$page=1;
		if(isset($_GET['page']))
		{
		...
		$vitri=($page-1)*8;
		$dem=0;
		$kq=truyvan("select * from sanpham where maloai in('L01','L02','L03') limit $vitri,8");
		foreach($kq as $r)
		{
            ...
            //         <a onClick='thongbao()' href='do-an.php?sp={$r['masp']}'>
...
<?php
		...
		$sosp=count(truyvan("select * from sanpham where maloai in('L01','L02','L03')"));
		$sotrang=ceil($sosp/8);
		phantrang('do-an.php',$page,$sotrang);
		?>
        </div>

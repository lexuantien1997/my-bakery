...
<div class="row slider">
 ...
 <div class="row">
   ...
   <div class="col-md-8 col-md-off-set-1">
	 <h2 class="bg-lienhe" style="padding-left:30px">Thông tin liên hệ</h2>
        <p style="padding-top:10px; padding-left:30px"><span style="font-size:20px">Mọi thắc mắc vui lòng liên hệ:</span></p>
        <p style="padding-left:30px"><span>Email: ddpromotion@dunkindonutsvn.vn
            <br>
        Địa chỉ: 91 Pasteur, P. Bến Nghé, Q.1, HCM
        <br>
        Số điện thoại: 0909 036 117</span></p>
	</div>
   <div class="col-md-7 col-md-off-set-1">
	 <h2 class="bg-lienhe" style="padding-left:30px">Tuyển dụng</h2>
        <p style="padding-top:10px; padding-left:30px "><span style="font-size:20px;">Cơ hội nghề nghiệp
</span></p>
        <p style="padding-left:30px"><span>Bạn có muốn trở thành Barista của Dunkin' Donuts - Cơ hội đã đến với bạn rồi đây! Nộp hồ sơ ứng tuyển nào!</span></p>
        <p style="padding-top:10px; padding-left:30px"><span style="font-size:20px;">Vị trí tuyển dụng
</span></p>
     <p style="padding-left:30px"><span>Nhân viên Part-time (làm 4-6h/ngày, ca xoay) Làm việc tại cửa hàng của PASTRY Bakery:</span></p>
     <p style="padding-left:30px"><span>- PASTRY Bakery Nguyễn Đình Chiểu: 410 - 414 Nguyễn Đình Chiểu, P.4, Q.3, HCM</span></p>
     <p style="padding-left:30px"><span>- PASTRY Bakery Lotte Mart: Tầng trệt Lotte Mart, 469 Nguyễn Hữu Thọ, Q.7, HCM</span></p>
        <p style="padding-top:10px; padding-left:30px"><span style="font-size:20px;">Yêu cầu cung
</span></p>
        <p style="padding-left:30px"><span>- Tuổi từ 18 - 30, nam & nữ (ưu tiên NAM)</span></p>
        <p style="padding-left:30px"><span>- Tốt nghiệp 12 trở lên.</span></p>
        <p style="padding-left:30px"><span>- Thời gian làm việc linh hoạt.</span></p>
        <p style="padding-left:30px"><span>- Ngoại hình khá, năng động, thành thật.</span></p>
        <p style="padding-left:30px"><span>- Anh Văn giao tiếp.</span></p>
        <p style="padding-left:30px"><span>- Tốt nghiệp 12 trở lên.</span></p>
        <p style="padding-left:30px"><span>- Sẵn sàng làm việc trong dịp Lễ, Tết.</span></p>
        <p style="padding-left:30px"><span>- Sức khỏe tốt (Yêu cầu: khám sức khỏe dành cho mảng nhà hàng, chỉ nộp thẻ khi nhận việc).</span></p>
        <p style="padding-top:10px; padding-left:30px"><span style="font-size:20px;">Phương thức ứng tuyển
</span></p>
     <p style="padding-left:30px"><span>Nộp hồ sơ online bằng cách điền thông tin ngay tại đây:<a href="https://docs.google.com/forms/d/e/1FAIpQLSfTVoDPL37D1NsLZvOUPd9EymNOivZrAewhcGmPYL3LLc9jRg/viewform"> https://goo.gl/forms/QQjQ1gMzIfu7gpKF3</a></span></p>
     <p style="padding-top:10px; padding-left:30px"><span style="font-size:20px;">Thời hạn ứng tuyển
</span></p>
     <p  style="padding-left:30px"><span>đến hết ngày 11/12/2017</span></p>
    </div>
<div class="col-10 col-md-offset-1">
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.6757668549963!2d106.66466961532923!3d10.759452492333036!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752ee53b2415b7%3A0xe0c7e7adc25afe37!2zTOG6p3UgMiwsIDEzN0UgTmd1eeG7hW4gQ2jDrSBUaGFuaCwgcGjGsOG7nW5nIDksIFF14bqtbiA1LCBI4buTIENow60gTWluaCwgVmnhu4d0IE5hbQ!5e0!3m2!1svi!2s!4v1513757727488" width="100%" height="500" frameborder="0" style="box-shadow:#666 1px 1px 10px" allowfullscreen></iframe>
		</div>
	</div>
</main>

...
<div class="row">
	...
	<div class="col-md-8 col-md-off-set-1">
		<h2 class="bg-lienhe" style="padding-left:30px">Giỏ hàng</h2>
        <?php
		...
		?>
        <a style="float:right; font-size:25px" href="xoagiohang.php"><b>Xoá hết</b></a>
		<form method="post">
        <table width="500px" border="1" cellspacing="2" cellpadding="2" align="center">
          <tr align="center" style="background-color:#900; color:#FFF; font-weight:bold; font-size:24px; height:40px;">
            <td width="41">Mã </td>
		  ...
		  ?>
           <tr align="center" style="height:60px">
            <td><?php echo $node['masp']?></td>
            <td><?php echo $node['tensp']?></td>
            <td align="center"><img src="images/<?php echo $node['luu']?>/<?php echo $node['hinhanh']?>" width="50px" height="50px" /></td>
          
          
            <td><input type="text" name="sl[]"  value="<?php echo $v?>" size="3"  style="text-align:center"/></td>
            <td><?php echo number_format((int)$node['gia'])?> VNĐ</td>
            <td><a href="xoagiohang.php?xoa=<?php echo $node['masp']?>"><img src="images/xoa.png" width="30"></a></td>
          </tr>
          <?php
					}
				}
          ...
          <tr align="center">
            <td colspan="6">
            <input type="submit" name="btncapnhat"  value="Cập nhật" style="font-family:Dancing Script; font-size: 18px; font-weight:bold; border-radius: 10px; width: 80px; height: 30px; background-color: #FF0004; color: #fff"/>
           <a href="dathang.php"><input type="button" name="btndathang"  value="Đặt hàng" style="font-family:Dancing Script; font-size: 18px; font-weight:bold; border-radius: 10px; width: 80px; height: 30px; background-color: #FF0004; color: #fff" /></a> &nbsp;

...
<div class="row slider">
	...
	<div class="row">
      <div class="col-md-2 col-md-offset-1">
		...
		<div class="bg-lienhe-sanpham3 h2-sanpham2" style="padding-left:30px; color:#000">Thức uống khác</div>
       <div class="homeproduct">
		...
		if(isset($_GET['sp']))
		{
			...
			echo'<meta http-equiv="refresh" content="0; thuc-uong-khac.php" />';
		}
		$dem=0;
		$page=1;
		if(isset($_GET['page']))
		...
		$vitri=($page-1)*8;
		$kq=truyvan("select * from sanpham where maloai='L05' limit $vitri,8");
		foreach($kq as $r)
		{
           ...
           // $english_format_number = number_format($r["gia"]);
            ...
            //     <a onClick='thongbao()' href='thuc-uong-khac.php?sp={$r['masp']}'>
            ...
            //             <li>
            //                 <a>
            //                     <img width='180' height='180' src='images/NUOC/{$r['hinhanh']}'>
            //                     <h3>{$r['tensp']}</h3>
            //                     <div class='price'>
		...
		$sosp=count(truyvan("select * from sanpham where maloai in('L05')"));
		$sotrang=ceil($sosp/8);
		phantrang('thuc-uong-khac.php',$page,$sotrang);
		?>
        </div>

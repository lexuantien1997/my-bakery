	...
	<div class="row">
      <div class="col-md-2 col-md-offset-1">
        ...
        <div  class="col-md-8 col-md-off-set-1">
            <div class="bg-lienhe-sanpham2 h2-sanpham2" style="padding-left:30px; color:#000">Đồ ăn</h2><a href="do-an.php"><span class="xemthem-sanpham">Xem thêm</span></a>
            </div>
        ...
        <div class="homeproduct">
            <?php 
                ...
                if(isset($_GET['sp']))
                {
                    ...
                    echo'<meta http-equiv="refresh" content="0; sanpham.php" />';
                }


                $dem=0;
                $kq=truyvan("select * from sanpham where maloai='L01' limit 8");
                foreach($kq as $r)
                {
                    ...
                    //     <a onClick='thongbao()' href='sanpham.php?sp={$r['masp']}'>
        ...
        <div class="bg-lienhe-sanpham h2-sanpham" style="padding-left:30px; color:#000">Thức uống</h2><a href="thuc-uong.php"><span class="xemthem-sanpham">Xem thêm</span></a></div>
           
           <div class="homeproduct">
            <?php 
                $dem=0;
                $kq=truyvan("select * from sanpham where maloai='L04' limit 8");
                foreach($kq as $r)
                {
                    $english_format_number = number_format($r["gia"]);
                    $r["gia"] = $english_format_number;
...
<?php
                    ...
                    // onClick='thongbao()'  href='sanpham.php?sp={$r['masp']}'
                        // echo "
                        // <div class='product-item cd-item'>
                        //     <a class='cd-trigger'>
                        //         <img class='image'  src='images/NUOC/{$r['hinhanh']}'/>                
                        //         <span class='title'>{$r['tensp']}</span>
                        //         <p class='price-sale'>{$english_format_number} đ</p>
                        //     </a>                    
                        // </div>";			
            ...
            <!-- <div class="popup" id="popup">
                ...
                <div class="popup__text">
                    <h1 id='productname'><span></span></h1>

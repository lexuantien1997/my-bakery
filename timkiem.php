...
<div class="row slider">
	...
	<div class="row">
      <div class="col-md-2 col-md-offset-1">
		...
		<div class="bg-lienhe-sanpham2 h2-sanpham2" style="padding-left:30px; color:#000">Sản phẩm tìm kiếm</div>
        <div align="left" style="font-size:16px"><?php echo 'Từ khoá '."' ".$_SESSION['search']." '"?></div>
       <div class="homeproduct">
		...
		if(isset($_GET['sp']))
		{
			...
			echo'<meta http-equiv="refresh" content="0; timkiem.php" />';
		}
		if(isset($_SESSION['search']))
		{
			...
			$vitri=($page-1)*8;
			$ten=$_SESSION['search'];
			$kq=truyvan("select * from sanpham,loaibanh where sanpham.maloai=loaibanh.maloai and tensp like concat('%','$ten','%') limit $vitri,8");
			$dem=0;
			foreach($kq as $r)
			{
                ...
                //$r['hinhanh'] = "images/NUOC/".$r['hinhanh'];
                $r['hinhanh'] = "images/{$r['luu']}/{$r['hinhanh']}";
             //   $english_format_number = number_format($r["gia"]);
                ...
                //     <a onClick='thongbao()' href='timkiem.php?sp={$r['masp']}'>
                //         <img class='image' src='images/{$r['luu']}/{$r['hinhanh']}'/>                
                ...
                //         <li>
                //             <a>
                //                 <img width='180' height='180' src='images/{$r['luu']}/{$r['hinhanh']}'>
                //                 <h3>{$r['tensp']}</h3>
                //                 <div class='price'>
    ...
    <?php
				...
				// echo "<div class='col-md-2 img-cake2' style='$style'><a onClick='thongbao()'   href='timkiem.php?sp={$r['masp']}'><img src='images/{$r['luu']}/{$r['hinhanh']}' class='img-cake'/><span class='text-cake2'>{$r['tensp']}</span></a></div>";
				$dem++;
				if($dem>3)
				{
					$dem=0;
		...
		$sosp=count(truyvan("select * from sanpham,loaibanh where sanpham.maloai=loaibanh.maloai and tensp like concat('%','$ten','%')"));
		$sotrang=ceil($sosp/8);
		phantrang('timkiem.php',$page,$sotrang);	
		}
		else
		echo "không tìm thấy";

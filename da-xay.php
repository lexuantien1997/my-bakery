...
<div class="row slider">
	...
	<div class="row">
      <div class="col-md-2 col-md-offset-1">
		...
		<div class="bg-lienhe-sanpham h2-sanpham2" style="padding-left:30px; color:#000">Đá xay</div>
		...
		if(isset($_GET['sp']))
		{
			...
			echo'<meta http-equiv="refresh" content="0; da-xay.php" />';
		}
		$dem=0;
		$sp=0;
		$page=1;
		...
		$vitri=($page-1)*8;
		$kq=truyvan("select * from sanpham where maloai='L04' limit $vitri,8");
		foreach($kq as $r)
		{
            ...
            //     <a onClick='thongbao()' href='da-xay.php?sp={$r['masp']}'>
...
<?php
		...
		$sosp=count(truyvan("select * from sanpham where maloai in('L04')"));
		$sotrang=ceil($sosp/8);
		phantrang('da-xay.php',$page,$sotrang);
		?>
        </div>

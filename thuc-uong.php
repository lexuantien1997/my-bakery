...
<div class="row slider">
	...
	<div class="row">
      <div class="col-md-2 col-md-offset-1">
		...
		<div class="bg-lienhe-sanpham h2-sanpham2" style="padding-left:30px; color:#000">Đồ uống</div>
       ...
       <div class="homeproduct">
		...
		if(isset($_GET['sp']))
		{
			...
			echo'<meta http-equiv="refresh" content="0; thuc-uong.php" />';
		}
		$dem=0;
		$page=1;
		if(isset($_GET['page']))
		...
		$vitri=($page-1)*8;
		$kq=truyvan("select * from sanpham where maloai in('L04','L05') limit $vitri,8");
		foreach($kq as $r)
		{
            ...
            //     <a onClick='thongbao()' href='thuc-uong.php?sp={$r['masp']}'>
		...
		$sosp=count(truyvan("select * from sanpham where maloai in('L04','L05')"));
		$sotrang=ceil($sosp/8);
		phantrang('thuc-uong.php',$page,$sotrang);
		?>
        </div>
